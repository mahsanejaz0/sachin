                ...
                >
                    ...
                    >
                        <Div sx={{mb: 2}}>
                            ...
                            <Typography variant="p">Already have an account? <MyLink style={{color:'black'}} component="Link" to="/login">Login</MyLink>
</Typography>
                        </Div>

                        <Div sx={{mt: 'auto', textAlign:'center'}}>
                            <Link href="#" underline="none" sx={{display: 'inline-flex'}}>
                                <img src={`${ASSET_IMAGES}/logo-white.png`} style={{width:'150px'}} alt="Aura Coinex"/>
                            </Link>
                        </Div>
                    </Div>
                </CardContent>
...
<Grid container spacing={2}>
  ...
  <FormControlLabel
    ...
    label={
      <span>
        I accept{" "}
        <a href="https://globaldynamicsavings.com/wp-content/uploads/2023/06/Global-Dynamic-Savings-Group-Member-Compliance-Non-Disclosure-Agreement_05.24.23.pdf" target="_blank">
