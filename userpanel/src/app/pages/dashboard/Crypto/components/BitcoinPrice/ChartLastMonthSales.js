...
const ChartLastMonthSales = () => {
    ...
    const dailyTraffic = loginUserData.balancetransactions
    return (
            ...
            <AreaChart data={dailyTraffic} margin={{top: 0, right: 0, left: 0, bottom: 0}}>
                <defs>
                    <linearGradient id="colorLastMonthSales" x1="0" y1="0" x2="0" y2="1">
                        ...
                        <stop offset="95%" stopColor="#c6a779"/>
                    </linearGradient>
                </defs>
                <Tooltip
                ...
                <Area type={"monotone"} dataKey="amount" strokeWidth={2} stackId="2" stroke="#FFf"
