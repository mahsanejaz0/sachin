...

{
  ...
  renderCell: (params) => (
    ...
    <Tooltip title="Approve">
                <IconButton onClick={() => handleActionClick(params.row.paymentid, 'Approve')}>
                  <CreditScoreIcon color='success' />
                </IconButton>
    </Tooltip>
    <Tooltip title="Reject">
                <IconButton onClick={() => handleActionClick(params.row.paymentid, 'Reject')}>
