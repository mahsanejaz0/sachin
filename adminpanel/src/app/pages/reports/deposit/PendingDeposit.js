...
import { deployuser, getdepositlist, postRequest, rejectpayment } from 'backendServices/ApiCalls';
...
const VISIBLE_FIELDS = ['sr','senderusername', 'amount', 'hash', 'status', 'createdat'];
...
const PendingDeposit = () => {
  ...
  const handleActionClick = (id,amount, action) => {
    ...
    if (action === 'approved') {
      ...
      description = 'Are you sure you want to approve this deposit?';
      confirmFunction = ()=>handleApprove(id,amount);
      variant = 'warning';
    } else if (action === 'rejected') {
      title = 'Reject Deposit';
      description = 'Are you sure you want to reject this deposit?';
  ...
  return (
    <JumboDemoCard title={'Pending Deposits'} wrapperSx={{ backgroundColor: 'background.paper', pt: 0 }}>
